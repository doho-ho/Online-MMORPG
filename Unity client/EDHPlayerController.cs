...
namespace Gamekit3D
{
    ...
    public class EDHPlayerController : MonoBehaviour, IMessageReceiver
    {
        protected static EDHPlayerController s_Instance;
        public static EDHPlayerController instance { get { return s_Instance; } }
        ...
        public gameCamera cameraSettings;            // Reference used to determine the camera's direction.
        ...
        void Reset()
        {
            ...
            cameraSettings = FindObjectOfType<gameCamera>();
        ...
        void OnEnable()
        {
            SceneLinkedSMB<EDHPlayerController>.Initialise(m_Animator, this);
        ...
        void SetTargetRotation()
        {
            ...
            Vector3 forward = Quaternion.Euler(0f, cameraSettings.transform.rotation.y, 0f) * Vector3.forward;
            forward.y = 0f;
            forward.Normalize();
